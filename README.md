* Kintohub已经封了这个项目，所以只能部署到了，下面是部署到的方法。
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/lixiaodongsql/javatake)
